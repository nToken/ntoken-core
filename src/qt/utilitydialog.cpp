    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("NToken Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About NToken Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  ntoken-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the NToken in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 NTK, 0.1 NTK, 1 NTK and 10 NTK -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://ntoken.atlassian.net/wiki/display/DOC/PrivateSend\">https://ntoken.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("NToken Core is shutting down...") + "<br /><br />" +
