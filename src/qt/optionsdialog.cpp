    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("NTE-light"), QVariant("light"));
    ui->theme->addItem(QString("NTE-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("NTE-traditional"), QVariant("trad"));
