    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("NToken Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NToken address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ntoken: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About NToken Core"), this);
    aboutAction->setStatusTip(tr("Show information about NToken Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NToken Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NToken addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NToken addresses"));
    ...
    openAction->setStatusTip(tr("Open a ntoken: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NToken Core help message to get a list with possible NToken Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("NToken Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NToken network", "", count));
    } else {
...
{
    QString strTitle = tr("NToken Core"); // default title
