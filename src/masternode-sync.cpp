...
void CMasternodeSync::BumpAssetLastTime(std::string strFuncName)
{
    ...
    nTimeLastBumped = GetTime();
    LogPrint("nodesync", "CMasternodeSync::BumpAssetLastTime -- %s\n", strFuncName);
}
...
{
    LogPrint("nodesync", "CMasternodeSync::AcceptedBlockHeader -- pindexNew->nHeight: %d\n", pindexNew->nHeight);
...
{
    LogPrint("nodesync", "CMasternodeSync::NotifyHeaderTip -- pindexNew->nHeight: %d fInitialDownload=%d\n", pindexNew->nHeight, fInitialDownload);
...
{
    LogPrint("nodesync", "CMasternodeSync::UpdatedBlockTip -- pindexNew->nHeight: %d fInitialDownload=%d\n", pindexNew->nHeight, fInitialDownload);
    ...
    LogPrint("nodesync", "CMasternodeSync::UpdatedBlockTip -- pindexNew->nHeight: %d pindexBestHeader->nHeight: %d fInitialDownload=%d fReachedBestHeader=%d\n",
