...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all NToken related functionality
...
/*
    ...
    allow endless transaction that would bloat NToken and make it unusable. To
