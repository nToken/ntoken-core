...
//
// The Masternode Class. For managing the Darksend process. It contains the input of the 20000NTE, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 1000 NTE - checking if valid masternode)
