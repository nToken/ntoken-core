...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "NTokenNetwork") type = NTokenNetwork;
    if(strType == "NTokenNetworkVariable") type = NTokenNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == NTokenNetwork) s = "NTokenNetwork";
    if(type == NTokenNetworkVariable) s = "NTokenNetworkVariable";
