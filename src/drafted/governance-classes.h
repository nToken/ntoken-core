 ...
 *
 *   // network
 *   CNTokenNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.ntoken.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CNTokenNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: NTokenNetwork
// //   -- signature requirements : Key1(User)
// class CNTokenNetworkVariable : public CGovernanceObject
// {
// private:
