...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 262800; // Note: actual number of blocks every two years
        ...
        genesis = CreateGenesisBlock(1520394000, 22563136, 0x1e0ffff0, 1, 128 * COIN);
