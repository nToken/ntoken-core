...
#define BOOST_TEST_MODULE NToken Test Suite

#include "test_ntoken.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_ntoken_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
