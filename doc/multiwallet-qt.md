...
Only requiring some minor changes is ntoken.cpp.
...
Changes to ntoken.cpp
----------------------
ntoken.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
