...
This mechanism has been integrated into Bitcore-Node-NToken which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ntoken/insight-api-ntoken#web-socket-api](https://github.com/ntoken/insight-api-ntoken#web-socket-api)
* API: [https://github.com/ntoken/insight-api-ntoken#instantsend-transactions](https://github.com/ntoken/insight-api-ntoken#instantsend-transactions)
...
By default, the NToken Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the NToken Core daemon:
